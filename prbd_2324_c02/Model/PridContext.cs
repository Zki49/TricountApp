    ...
    public  void seedData(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity<Operations>().HasData(new Operations { OperationsId = 1, title = "Colruyt", tricountId = 1, Amount = 100, DateTime = new DateTime(2023, 10, 13), userId = 2 },
               ...
               modelBuilder.Entity<Repartitions>().HasData(new Repartitions { weight = 1, userId = 1, operationsID = 1 },
                                                          ...
                                                          new Repartitions { weight = 1, userId = 4, operationsID = 3 },
                                                          new Repartitions { weight = 1, userId = 1, operationsID = 4 },
                                                          new Repartitions { weight = 2, userId = 2, operationsID = 4 },
                                                          new Repartitions { weight = 3, userId = 4, operationsID = 4 },
                                                          new Repartitions { weight = 2, userId = 1, operationsID = 5 },
                                                          new Repartitions { weight = 1, userId = 2, operationsID = 5 },
                                                          new Repartitions { weight = 1, userId = 4, operationsID = 5 },
                                                          new Repartitions { weight = 1, userId = 1, operationsID = 6 },
                                                          new Repartitions { weight = 1, userId = 4, operationsID = 6 },
                                                          new Repartitions { weight = 1, userId = 2, operationsID = 7 },
                                                          new Repartitions { weight = 2, userId = 4, operationsID = 7 },
                                                          new Repartitions { weight = 3, userId = 5, operationsID = 7 },
                                                          new Repartitions { weight = 2, userId = 4, operationsID = 8 },
                                                          new Repartitions { weight = 1, userId = 5, operationsID = 8 },
                                                          new Repartitions { weight = 1, userId = 2, operationsID = 9 },
                                                          new Repartitions { weight = 5, userId = 5, operationsID = 9 },
                                                          new Repartitions { weight = 1, userId = 1, operationsID = 10 },
                                                          new Repartitions { weight = 1, userId = 4, operationsID = 10 },
                                                          new Repartitions { weight = 2, userId = 2, operationsID = 11 },
                                                          new Repartitions { weight = 2, userId = 5, operationsID = 11 }
                                                    );
        ...
        modelBuilder.Entity<Template_items>().HasData(new Template_items { weight = 2, templateId = 1, userId = 1 },
                                                      ...
                                                      new Template_items { weight = 1, templateId = 1, userId = 4 },
