...
public class PridContext : DbContextBase
{
    ...
    public  void seedData(ModelBuilder modelBuilder) {
        ...
        var user3 = new User { UserId = 3, FullName = "Xavier", hashedPassword = "5B979AB86EC73B0996F439D0BC3947ECCFA0A41310C77533EA36CB409DBB1243:0CF43009110DE4B4AA6D4E749F622755:100000:SHA256", mail = "xapigeolet@epfc.eu", Role = false };
        var user4 = new User { UserId = 4, FullName = "Marc", hashedPassword = "955F147CE3473774E35EE58F4233AA84AE9118C6ECD4699DD788B8D588238034:5514D1DD0A97E9BA7FE4C0B5A4E89351:100000:SHA256", mail = "mamichel@epfc.eu", Role = false };
        var user5 = new User { UserId = 5, FullName = "Administrator", hashedPassword = "C9949A02A5DFBE50F1DA289DC162E3C97443AB09CE6F6EB1FD0C9D51B5241BBD:5533437973C5BC6459DB687CA5BDE76C:100000:SHA256", mail = "admin@epfc.eu", Role = true };
        ...
        var tricount3 = new Tricount { Id = 4, Title = "Vacances ", Description = "A la mer du nord", CreatorId = 1, CreatedAt = new DateTime(2023, 10, 10, 19, 31, 9) };
        var tricount4 = new Tricount { Id = 5, Title = "Grosse virée ", Description = "A Torremolinos", CreatorId = 2, CreatedAt = new DateTime(2023, 8, 15, 10, 0, 0) };
        var tricount5 = new Tricount { Id = 6, Title = "Torhout Werchter ", Description = "Memorabile", CreatorId = 3, CreatedAt = new DateTime(2023, 6, 2, 18, 30, 12) };


        modelBuilder.Entity<Tricount>().HasData(tricount1, tricount2, tricount3, tricount4, tricount5);





        modelBuilder.Entity<Subscription>().HasData(new Subscription { TricountId = 1, UserId = 1 },
                                                    new Subscription { TricountId = 2, UserId = 1 },
                                                    new Subscription { TricountId = 4, UserId = 1 },
                                                    new Subscription { TricountId = 6, UserId = 1 },
                                                    new Subscription { TricountId = 2, UserId = 2 },
                                                    new Subscription { TricountId = 4, UserId = 2 },
                                                    new Subscription { TricountId = 5, UserId = 2 },
                                                    new Subscription { TricountId = 6, UserId = 2 },
                                                    new Subscription { TricountId = 4, UserId = 3 },
                                                    new Subscription { TricountId = 5, UserId = 3 },
                                                    new Subscription { TricountId = 6, UserId = 3 },
                                                    new Subscription { TricountId = 4, UserId = 4 },
                                                    new Subscription { TricountId = 5, UserId = 4 },
                                                    new Subscription { TricountId = 6, UserId = 4 }
                                                    );



        modelBuilder.Entity<Operations>().HasData(new Operations { OperationsId = 1, title = "Colruyt", tricountId = 4, Amount = 100, CreatAt = new DateTime(2023, 10, 13), userId = 2 },
                                              new Operations { OperationsId = 2, title = "Plein essence", tricountId = 4, Amount = 75, CreatAt = new DateTime(2023, 10, 13), userId = 1 },
                                              new Operations { OperationsId = 3, title = "Grosses courses LIDL", tricountId = 4, Amount = 212.47, CreatAt = new DateTime(2023, 10, 13), userId = 3 },
                                              new Operations { OperationsId = 4, title = "Apéros", tricountId = 4, Amount = 31.89745622, CreatAt = new DateTime(2023, 10, 13), userId = 1 },
                                              new Operations { OperationsId = 5, title = "Boucherie", tricountId = 4, Amount = 25.5, CreatAt = new DateTime(2023, 10, 26), userId = 2 },
                                              new Operations { OperationsId = 6, title = "Loterie", tricountId = 4, Amount = 35, CreatAt = new DateTime(2023, 10, 26), userId = 1 },
                                              new Operations { OperationsId = 7, title = "Sangria", tricountId = 5, Amount = 42, CreatAt = new DateTime(2023, 08, 16), userId = 2 },
                                              new Operations { OperationsId = 8, title = "Jet Ski", tricountId = 5, Amount = 250, CreatAt = new DateTime(2023, 08, 17), userId = 3 },
                                              new Operations { OperationsId = 9, title = "PV parking", tricountId = 5, Amount = 15.5, CreatAt = new DateTime(2023, 08, 16), userId = 3 },
                                              new Operations { OperationsId = 10, title = "Tickets", tricountId = 6, Amount = 220, CreatAt = new DateTime(2023, 06, 08), userId = 1 },
                                              new Operations { OperationsId = 11, title = "Décathlon", tricountId = 6, Amount = 199.99, CreatAt = new DateTime(2023, 07, 01), userId = 2 }
                                                );
        ...
        modelBuilder.Entity<Repartitions>().HasData(
                                                 ...
                                                 new Repartitions { weight = 1, userId = 1, operationsID = 5 },
                                                 new Repartitions { weight = 2, userId = 2, operationsID = 5 },
                                                 ...
                                                 new Repartitions { weight = 1, userId = 3, operationsID = 7 },
        ...
        modelBuilder.Entity<Template>().HasData(new Template { Id = 1, Title = "Boris paye double", TricountId = 4 },
                                           new Template { Id = 2, Title = "Benoît ne paye rien", TricountId = 4 }
                                           );


        modelBuilder.Entity<Template_items>().HasData(new Template_items { weight = 2, templateId = 1, userId = 1 },
